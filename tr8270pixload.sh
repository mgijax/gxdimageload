...
#
#            1) Image file name (e.g. MH00000099_00001B.jpg)
...
for FILE in `cat ${PIXELDB_FILES}`
do
    # Insert an extra "0" in the file name to make it match the actual name
    # of the file.  The file names in the XML files are missing a "0".
    # For example: MH00000099_0003B.jpg should be MH00000099_00003B.jpg
    #
    FILENAME=`echo ${FILE} | sed 's/_/_0/'`

    # If the best image file is in the fullsize directory, copy it to the
    ...
    # image list.  If the best image file does not exist, write the file
    ...
    # If the best image file is in the thumbnail directory, copy it to the
    # pixel DB directory, renaming it with the next accession number.
