...
logicalDBKey = os.environ['EUREXPRESS_LOGICALDB']
...
def process ():
    ...
    for r in results:
        ...
        #
        # The figure label is used for the acc ID (e.g. "euxassay_000001_01").
        #
        accID = figureLabel
        prefixPart = figureLabel[0:-2]
        numericPart = figureLabel[-2:]
