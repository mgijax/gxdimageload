...
for FILENAME in `cat ${PIXELDB_FILES}`
do
    # If the pix image file is in the fullsize directory, copy it to the
    ...
    # If the pix image file is in the thumbnail directory, copy it to the
    # pixel DB directory, renaming it with the next accession number.
