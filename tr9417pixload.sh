...
#
#      - FULLSIZE_IMAGE_DIR (/mgi/all/GXD/From_Sirannon_Mgi_all_GXD/GXD/J139177_images/FullsizeImages)
#
#      - THUMBNAIL_IMAGE_DIR (/mgi/all/GXD/From_Sirannon_Mgi_all_GXD/GXD/J139177_images/ThumbnailImages)
#
#  Outputs:
#
...
#
#            1) Image file name (e.g. DA108_Embryo_C1470_1_4C.jpg)
...
rm -f ${PIX_FULLSIZE} ${PIX_THUMBNAIL}
touch ${PIX_FULLSIZE} ${PIX_THUMBNAIL}
